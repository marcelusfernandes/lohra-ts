...
| `leaf.completed`    | `close()` (`audit-runtime.ts:317-344`), chamado de `collect()` (`audit-runtime.ts:468-504`)                                                                                                                                                         | `collect` volta `status: "complete"`; `payload.partial: true` (nunca `false`) quando o turno concluído absorveu ao menos um steer que interrompeu uma chamada em voo (D3/#520, M16-S5) — o `usage` já inclui essa parcela ESTIMADA (`ConversationRuntime.runTurn`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
