...
// mutante `Q1-quota-guard-removed` (âncora `src/workflow/engine-utils.ts:490`,
// `if (collected.errorKind !== QUOTA_EXHAUSTED) recordFaultKind(...)`) não
// entrava na fatia `workflow-executor` porque `focalTests` de
// `workflow-executor-mutants.ts` não incluía `tests/workflow-fault-kinds.test.ts`
// e `tests/mutations-slices.test.ts:434` pina a igualdade entre `focalTests`
