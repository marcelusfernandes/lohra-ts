...
// depois do kill; o segundo prova a escrita sob fence — com aquisição
// obsoleta, a escrita de progresso não sobrescreve a linha.
import type { Declaracao } from "../scripts/prova/tipos.js";

export default {
  unit: ["tests/workflow-cross-process.test.ts", "tests/workflow-service-durability.test.ts"],
