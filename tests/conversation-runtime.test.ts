...
describe("ConversationRuntime", () => {
  ...
  // covered above). No live transport in this tree produces this shape
  // anymore (#567 folded the one that used to into `StreamAbortedError`
  // too, `src/transports/client.ts:150-165`) — kept as defense in depth for
  // an external `ModelTransport`.
