...
import { launchCandidateDashboard, type LaunchedGatewayProcess } from "../../scripts/parity/gateway/launch-candidate.js";
...
describe("launchCandidateDashboard: a real subprocess, probed over raw sockets", () => {
  it(
    "boots, serves authenticated REST, and completes a real RFC6455 WS handshake",
    async () => {
      const home = tempHome();
