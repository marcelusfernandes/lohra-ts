...
describe("builtin registry", () => {
  it("registers the 24 Python schemas plus the 5 native ones (workflow_notices/_ack, #402; workflow_leaf_read, #425; workflow_steer, #424; workflow_preview, #462) in exact order", () => {
